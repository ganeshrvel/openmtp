...
export const APP_GITHUB_RELEASES_URL = `https://github.com/ganeshrvel/openmtp/releases/latest`;

export const APP_GITHUB_API_URL = `https://api.github.com/repos/ganeshrvel/openmtp/releases/latest`;

export const APP_GITHUB_REPO_API_URL = `https://api.github.com/repos/ganeshrvel/openmtp`;
